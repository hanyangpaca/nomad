...
// 쓰는 순서를 신중하게 써야한다. >80 이 ===100 보다 먼저 쓰이면 100이 나오더라도 100의 경우를 실행하지 않는다.

// === 은 유형도 비교하기 때문에 ===를 사용하는 것이 좋다. ==는 단순 값만 비교한다.
// 0 == false 는 true가 나오고 0 === false 는 false가 나온다. ( 0을 바이너리 관점으로 보게 되면 )
